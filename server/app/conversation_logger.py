...
This module tracks all user-bot conversations, anonymizes PII using Microsoft Presidio,
...
class ConversationLogger:
    ...
    def __init__(self, storage_connection_string: str):
        ...
        # Use Microsoft Presidio for enterprise-grade PII detection with multilingual support
        # Support Italian and English by default (auto-detects language per message)
        self.pii_anonymizer = PIIAnonymizerPresidio(reversible=True, languages=["it", "en"])
